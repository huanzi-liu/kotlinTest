...
import static com.example.testdemo.pagerrecyclerview.PagerConfig.Loge;

class PagerGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        Log.i("tag","Item onLayoutChildren");
        Log.i("tag","Item onLayoutChildren isPreLayout = " + state.isPreLayout());
        Log.i("tag","Item onLayoutChildren isMeasuring = " + state.isMeasuring());
        Log.e("tag","Item onLayoutChildren state = " + state);
    ...
    private void recycleAndFillItems(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        Log.e("tag","displayRect = " + displayRect.toString());
        ...
        Log.e("tag","startPos = " + startPos);
        Log.e("tag","stopPos = " + stopPos);
    ...
    int findNextPageFirstPos() {
        ...
        Log.e("tag","computeScrollVectorForPosition next = " + page);
    ...
    public void scrollToPage(int pageIndex) {
        ...
        Log.e("tag","mTargetOffsetXBy = " + mTargetOffsetXBy);
        Log.e("tag","mTargetOffsetYBy = " + mTargetOffsetYBy);
